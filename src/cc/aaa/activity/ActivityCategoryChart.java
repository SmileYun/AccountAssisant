...
public class ActivityCategoryChart extends ActivityFrame {
	...
	private View categoryStatistics() {
		int[] _Color = new int[] { Color.parseColor("#FF5552"), Color.parseColor("#2A94F1"), Color.parseColor("#F12792"),
				Color.parseColor("#FFFF52"), Color.parseColor("#84D911"), Color.parseColor("#5255FF") };
		// 渲染器
	...
	protected DefaultRenderer BuildCategoryRenderer(int[] colors) {
		...
		_Renderer.setLabelsTextSize(28);
		_Renderer.setLegendTextSize(28);
		_Renderer.setLabelsColor(Color.BLUE);
		_Renderer.setMargins(new int[] { 120, 30, 15, 10 });
		int _Color = 0;
	...
	protected void InitView() {
		// elvCategoryList = (ExpandableListView)
		// findViewById(R.id.ExpandableListViewCategory);
	...
	protected void BindData() {
		...
		for (int i = 0; i < mModelCategoryTotal.size(); i++) {
			...
			_Content += _ModelCategoryTotal.CategoryName + "--" + _ModelCategoryTotal.Count + "--"
					+ _ModelCategoryTotal.SumAmount + "\r\n";
		}
